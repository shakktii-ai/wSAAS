...
export default function DataDeletionInstructions() {
  return (
    <LegalLayout title="Data Deletion Instructions" description="Official Data Deletion Instructions required by Meta Developer App Review and GDPR.">
      <div className="space-y-6">
        ...
        <div className="prose prose-invert max-w-none text-xs text-slate-300 space-y-4 leading-relaxed">
          <section className="space-y-2 p-5 rounded-2xl bg-slate-900/60 border border-slate-800">
            ...
            <p>
              In accordance with Meta Developer Policies, SyncChat provides business users and Facebook accounts multiple options to request complete data deletion:
            </p>
            <ol className="list-decimal pl-5 space-y-1.5 text-slate-300">
              <li><strong>Via Dashboard Settings:</strong> Log in to your SyncChat Dashboard, navigate to <code>/dashboard/company</code>, and click <strong>&quot;Disconnect WhatsApp & Delete Workspace Data&quot;</strong>.</li>
              <li><strong>Via Facebook App Settings:</strong> Go to your Facebook Profile &gt; Settings &amp; Privacy &gt; Settings &gt; Apps and Websites &gt; Select SyncChat &gt; Click <strong>&quot;Remove&quot;</strong>.</li>
              <li><strong>Via Direct Privacy Request:</strong> Send an official deletion request email to <code>privacy@syncchat-saas.com</code> with your WABA ID or Company Email.</li>
            </ol>
          </section>
          ...
          <section className="space-y-2 p-5 rounded-2xl bg-slate-900/60 border border-slate-800">
            ...
            <p>
              Upon receiving a verified deletion request, SyncChat immediately revokes Meta OAuth access tokens and permanently purges all stored database collections within <strong>30 calendar days</strong>.
            </p>
          </section>
        </div>
      </div>
