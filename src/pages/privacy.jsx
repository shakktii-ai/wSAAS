...
export default function PrivacyPolicy() {
  return (
    <LegalLayout title="Privacy Policy" description="SyncChat Privacy Policy for GDPR, CCPA, and Meta Cloud API compliance.">
      <div className="space-y-6">
        ...
        <div className="prose prose-invert max-w-none text-xs text-slate-300 space-y-4 leading-relaxed font-normal">
          <section className="space-y-2 p-5 rounded-2xl bg-slate-900/60 border border-slate-800">
            ...
            <p>
              SyncChat Technologies Inc. (&quot;SyncChat&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;) operates the SyncChat B2B WhatsApp Cloud API communication platform. This Privacy Policy explains how we collect, process, store, and safeguard data when business customers (&quot;Tenants&quot;) use our platform, APIs, and Meta Embedded Signup integrations.
            </p>
          </section>
          ...
          <section className="space-y-2 p-5 rounded-2xl bg-slate-900/60 border border-slate-800">
            ...
            <p>
              SyncChat incorporates Enterprise AI Studio RAG (Retrieval-Augmented Generation) technology. Company knowledge documents and conversation messages are processed strictly to generate grounded customer support replies. We do NOT use tenant data to train public foundation models.
            </p>
          </section>
          ...
          <section className="space-y-2 p-5 rounded-2xl bg-slate-900/60 border border-slate-800">
            ...
            <p>
              Under GDPR and CCPA regulations, business administrators have the right to access, export, rectify, or permanently delete tenant data. Data deletion requests can be initiated via <a href="/data-deletion" className="text-emerald-400 underline">Data Deletion Instructions</a> or by contacting <code>privacy@syncchat-saas.com</code>.
            </p>
          </section>
        </div>
      </div>
