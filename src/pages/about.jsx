...
import { MessageSquare, Zap, ShieldCheck, Cpu, Code2, Server } from 'lucide-react';

export default function AboutSyncChat() {
  return (
    <LegalLayout title="About Us" description="About SyncChat Enterprise Multi-Tenant WhatsApp Communication SaaS.">
      <div className="space-y-6">
        <div>
          ...
          <h1 className="text-3xl font-extrabold text-white mt-3 tracking-tight">About SyncChat</h1>
          <p className="text-xs text-slate-400 mt-1">Empowering global businesses with official WhatsApp Cloud API automation and AI intelligence.</p>
        </div>
        ...
        <div className="prose prose-invert max-w-none text-xs text-slate-300 space-y-4 leading-relaxed">
          <section className="p-6 rounded-2xl bg-slate-900/60 border border-slate-800 space-y-2">
            ...
            <p>
              SyncChat was built to redefine B2B customer communication. By bridging Meta WhatsApp Cloud API with multi-agent Shared Inbox, Enterprise CRM, No-Code Visual Automation Workflows, and Multi-LLM RAG AI Studio, we enable companies to engage customers instantaneously at global scale.
            </p>
          </section>
